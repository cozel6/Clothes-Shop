...
abstract class Product {
    ...
    public Product(String name, double price, Size size, String color, int quantity, Gender gender) {
        ...
        if (price < 0 || quantity < 0) {
            throw new IllegalArgumentException("Prețul și cantitatea nu pot fi negative!");
        }
        this.name = name;
        this.price = price;
        this.originalPrice = price; // Stocăm prețul inițial pentru referință
        this.size = size;
        this.color = color;
    ...
    // Setteri pentru atribute ce se pot modifica
    ...
    public String toString() {
        return "Produs: " + name + ", Preț: " + price + ", Mărime: " + size + 
               ", Culoare: " + color + ", Cantitate: " + quantity + 
               ", Gen: " + gender;
    }
}
